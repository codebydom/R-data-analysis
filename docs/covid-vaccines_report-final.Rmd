---
title: "Covid19 Vaccinations 12-24-2020"
author: "CodeByDom"
date: "12/24/2020"
knit: (function(input_file, encoding) {
 ...
 encoding=encoding,
 output_file=file.path(dirname(input_file), out_dir, '12-24-2020.html'))})
---
...
```{r echo=FALSE,comment = "", prompt=FALSE,message=FALSE,warning=FALSE,fig.width=10,fig.height=6}
#top ten vaccinated states by total
ggplot(data=topTenStatesmP, aes( x = reorder(Jurisdiction,-Doses.allocated.week.of.12.21), y = Doses.allocated.week.of.12.21, fill=Jurisdiction)) +
  geom_bar(stat="identity") + xlab("States") + ylab("Total Number of Vaccines")
