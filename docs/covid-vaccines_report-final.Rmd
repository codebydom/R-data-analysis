...
finalDF3 <- inner_join(final_df,final_df2[1:7],by="Jurisdiction")  %>% mutate(total_vaccinated = Total.Moderna.Allocation..First.Dose..Shipments+Total.Pfizer.Allocation..First.Dose..Shipments,total_per = total_vaccinated/pop_2015*100)
