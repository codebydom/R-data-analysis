---
title: "Report on Covid 19 Vaccines Globally and in the United States"
author: "Dom Pizzano"
date: "12/19/2020"
...
ggplot(data=topTenStatesP, aes( x = reorder(abr, sort(First.Doses,TRUE)), y = First.Doses, fill=abr)) +
  geom_bar(stat="identity")
```

#### Figure 5: United States Density Map of Percentage of Population (2015) Vaccinated
...
#### Figure 6: United States Density Map of Total Vaccinations
```{r echo=FALSE,comment = "", prompt=FALSE,message=FALSE,warning=FALSE,fig.width=10,fig.height=6}
